...
Пункты 3,4,5,6 ты пишешь только при условии, что пользователь просит разобраться в какой-то юридической ситуации(собственной проблеме или в целом чьей-либо)
